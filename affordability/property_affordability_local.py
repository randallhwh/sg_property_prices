...
# Saves inputs to last_inputs.json in the same directory.
# Inputs are automatically restored on next app startup.
...
with st.sidebar:
    ...
    if st.button("💾 Save Inputs", use_container_width=True):
        ...
        st.success("✅ Saved to last_inputs.json — will reload on next startup.")
