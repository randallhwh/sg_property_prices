...
with st.sidebar:
    ...
    if st.button("🔗 Save & Get Shareable Link", use_container_width=True):
        ...
        st.success("✅ URL updated — copy the browser address bar to bookmark or share this scenario.")
        st.caption("The link encodes all inputs. Anyone with it opens your exact scenario instantly.")
